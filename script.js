...
playermodel.src = "img/dino.png";
const crouchplayermodel = new Image();
crouchplayermodel.src = "img/dinocrouch1.png";
const jumpsound = new Audio("sound/Jump8.wav");
const endsound = new Audio("sound/Hit_Hurt2.wav");
...
function changemodel() {
  if (player.jumping == false) {
    if (iterate < 2) {
      iterate++;
      playermodel.src = "img/dino1.png";
    } else {
      iterate--;
      playermodel.src = "img/dino2.png";
    }
  } else {
    playermodel.src = "img/dino3.png";
  }
